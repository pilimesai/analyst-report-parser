...
def update_manual_to_auto():
    ...
    # Find the "    else:" just before end_idx
    else_idx = content.rfind("    else:", start_idx, end_idx)
    if else_idx == -1:
        print("Could not find 'else:' before the st.info line.")
        return
...
"""
    ...
    content = content[:start_idx] + new_logic + content[else_idx:]
